...
/* Social icon SVGs — 20x20 to match Supafast's 24x24 display size */
const TwitterX = () => (
...
export const Footer: React.FC = () => {
  return (
    <footer className="footer">
      {/* Huge wordmark — full width, outlined */}
      <div className="footer__wordmark-wrap">
        <span className="footer__wordmark" aria-hidden="true">milktree</span>
      </div>
